...
const results = ref<Record<string, boolean | null | 'deleted'>>({})
...
onMounted(() => {
  results.value = { ...(props.measurementResults as Record<string, boolean | null | 'deleted'>) }
})
