...
defineOptions({ name: 'PercentageGroup' })
...
function onRecordProbe(val: boolean) {
  ...
  sessionStore.addSessionActivity({
    ...
    notes: `Group Percentage Target Member ${activeMember.value?.target_code} Probing: ${val}`,
...
function onRecordTeaching(val: boolean) {
  ...
  sessionStore.addSessionActivity({
    ...
    api: `PATCH /api/v1/measurements/${props.measurement.id}`,
    params: { measurement: { results: resultsState.value } },
    notes: `Group Percentage Target Member ${activeMember.value?.target_code} Teaching: ${val}`,
    timestamp: new Date().toISOString()
  })
...
function onRemoveProbe(idx: number) {
  ...
  sessionStore.addSessionActivity({
    ...
    api: `PATCH /api/v1/measurements/${props.measurement.id}`,
    params: { measurement: { results: resultsState.value } },
    notes: `Group Percentage Target Member ${activeMember.value?.target_code} Probing trial deleted`,
    timestamp: new Date().toISOString()
  })
...
function onCycleTeaching(key: string) {
  ...
  sessionStore.addSessionActivity({
    ...
    api: `PATCH /api/v1/measurements/${props.measurement.id}`,
    params: { measurement: { results: resultsState.value } },
    notes: `Group Percentage Target Member ${activeMember.value?.target_code} Teaching cycle: ${nextVal}`,
    timestamp: new Date().toISOString()
  })
...
function onAddTeachingTrial() {
  ...
  sessionStore.addSessionActivity({
    ...
    api: `PATCH /api/v1/measurements/${props.measurement.id}`,
    params: { measurement: { results: resultsState.value } },
    notes: `Group Percentage Target Member ${activeMember.value?.target_code} Teaching trial added`,
    timestamp: new Date().toISOString()
  })
...
function onRemoveTeachingTrial(key: string) {
  ...
  sessionStore.addSessionActivity({
    ...
    api: `PATCH /api/v1/measurements/${props.measurement.id}`,
    params: { measurement: { results: resultsState.value } },
    notes: `Group Percentage Target Member ${activeMember.value?.target_code} Teaching trial deleted`,
    timestamp: new Date().toISOString()
  })
